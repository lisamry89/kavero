...
export const mockWorkoutHistory: WorkoutSession[] = [
  {
    ...
    duration: "52 min",
    distance: "6.8 km",
    gaits: { arret: 0, pas: 22, trot: 18, galop: 12 },
    memories: [
    ...
    route: [
      ...
      { lat: 48.8571, lng: 2.3548, t: 9 * 60_000 },
      { lat: 48.8582, lng: 2.3561, t: 18 * 60_000 },
      { lat: 48.8579, lng: 2.359, t: 30 * 60_000 },
      { lat: 48.859, lng: 2.3615, t: 42 * 60_000 },
      { lat: 48.858, lng: 2.364, t: 52 * 60_000 },
    ],
  },
  {
    id: "w0",
    ...
    duration: "38 min",
    distance: "4.2 km",
    gaits: { arret: 0, pas: 30, trot: 8, galop: 0 },
    memories: [
      "https://images.unsplash.com/photo-1598974357801-cbca100e65d3?q=80&w=800&auto=format&fit=crop",
    ],
    route: [
      { lat: 48.85, lng: 2.34, t: 0 },
      { lat: 48.8515, lng: 2.339, t: 12 * 60_000 },
      { lat: 48.853, lng: 2.341, t: 22 * 60_000 },
      { lat: 48.8525, lng: 2.3435, t: 30 * 60_000 },
      { lat: 48.851, lng: 2.343, t: 38 * 60_000 },
    ],
  },
];
